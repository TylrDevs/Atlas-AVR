...
class MQTTClient(QtCore.QObject):
    ...
    def login(self, host: str, port: int) -> None:
        ...
        try:
            ...
            # emit success
            logger.success("Connected to MQTT server. We so innnnn")
...
class MQTTConnectionWidget(QtWidgets.QWidget):
    ...
    def set_connected_state(self, connection_state: ConnectionState) -> None:
        ...
        self.state_label.setText(
            f"State: {wrap_text(connection_state.name.title(), color_lookup[connection_state])}"+ str(" Bro is NOTTT ssh'd in :skull:")
        )
